...
function MemorizationHistoryDialog({
  student,
  open,
  onOpenChange,
  onSessionChanged,
  ...
  const fetchHistory = async () => {
    ...
    try {
      ...
      setHistory(memorizationSessions);
    } catch (err) {
          ...
          <DialogHeader>
            <DialogTitle className="flex items-center justify-between font-cairo text-xl">
              <div className="flex items-center gap-2">
                <BookOpen className="h-6 w-6 text-[#243048]" />
                <span>سجل الحفظ - {student?.name}</span>
              </div>
              <Button
            ...
            <div className="space-y-6">
                ...
                <div className="bg-gradient-to-br from-green-50 to-green-100 p-4 rounded-lg border border-green-200">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="font-cairo text-sm text-green-800">
                      {isChapterMethod ? "السور المكتملة" : "الأحزاب المكتملة"}
                    </span>
                  </div>
              ...
              {history.length === 0 ? (
                ...
                <div className="space-y-3">
                  <h3 className="font-cairo font-bold text-lg text-[#243048] border-b pb-2">
                    جميع الحصص ({history.length})
                  </h3>
                      ...
                      <div className="flex items-start justify-between gap-4">
                        ...
                        >
                          ...
                          <div className="flex items-center gap-3 mb-2">
                            <span className="font-cairo font-bold text-[#243048]">
        ...
        >
          <DialogContent className="max-w-2xl">
            ...
            <div className="space-y-4">
              {/* Session Info */}
              <div className="bg-gradient-to-r from-[#243048] to-[#027E01] text-white p-4 rounded-lg">
...
export default MemorizationHistoryDialog;
